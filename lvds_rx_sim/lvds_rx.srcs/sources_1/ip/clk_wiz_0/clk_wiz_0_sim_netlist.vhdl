...
--               e:/my_work/Horizon_lvds/lvds_rx/lvds_rx.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.vhdl
-- Design      : clk_wiz_0
...
architecture STRUCTURE of clk_wiz_0_clk_wiz_0_clk_wiz is
  signal clk_in189_clk_wiz_0 : STD_LOGIC;
  signal clk_out27_clk_wiz_0 : STD_LOGIC;
...
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
        ...
        port map (
      CE => '1',
      I => clk_out27_clk_wiz_0,
      O => clk_out27
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      BANDWIDTH => "OPTIMIZED",
      CLKFBOUT_MULT_F => 121.125000,
